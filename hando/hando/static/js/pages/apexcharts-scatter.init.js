...
var options = {
  ...
  colors: ["#287F71", "#963b68", "#27ebb0", "#E77636"],
  dataLabels: {
    enabled: false,
  },
  grid: {
...
var chart = new ApexCharts(
  document.querySelector("#datetime_scatter_chart"),
  options
);
chart.render();
  ...
  fill: {
    ...
    image: {
      src: [
        ...
        "./../static/images/users/user-10.jpg",
      ],
      width: 40,
      height: 40,
    },
...
var chart = new ApexCharts(
  document.querySelector("#images_scatter_chart"),
  options
);
chart.render();
