...
var chart = new ApexCharts(
  document.querySelector("#datalabel_line_chart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#syncing_line_chart"),
  options
);
chart.render();
...
var chartLine2 = new ApexCharts(
  document.querySelector("#syncing_line_chart2"),
  optionsLine2
);
chartLine2.render();
...
var chartArea = new ApexCharts(
  document.querySelector("#syncing_line_chart_area"),
  optionsArea
);
chartArea.render();
...
var chart = new ApexCharts(
  document.querySelector("#brush_line_chart"),
  options
);
chart.render();
...
var chartLine = new ApexCharts(
  document.querySelector("#brush_line_chart2"),
  optionsLine
);
chartLine.render();
  ...
  annotations: {
    ...
    points: [
      ...
      },
      {
        ...
        image: {
          path: "../../static/images/instagram.png",
        },
      },
    ],
  },
...
var chart = new ApexCharts(
  document.querySelector("#annotations_line_chart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#missingnull_line_chart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#realtime_line_chart"),
  options
);
chart.render();
